...
# --- ASSET LIST (Kopyalama hatasını önlemek için bölünmüş liste) ---
CMC_TOP_100 = [
    ...
    <body>
        ...
        <div class="max-w-7xl mx-auto p-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <button id="fav-btn" class="bg-blue-600 p-3 rounded-lg font-bold w-full hover:bg-blue-700 transition">⭐ Watchlist</button>
            </div>
        ...
        <script>
            ...
            function showSafeDetails(el) {
                ...
                for (const [k, v] of Object.entries(details)) {
                    if (k !== 'AI_Eval') content += `<div class="flex justify-between border-b border-gray-800 py-2"><span class="opacity-50">${k}</span><b>${v}</b></div>`;
                }
